...
export default function GuidelineDataLoading() {
  return (
    <div className="p-4 space-y-6 bg-background">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="border rounded-lg p-6 space-y-6 bg-card shadow-md">
          <h2 className="text-xl font-bold text-card-foreground">Guideline Text</h2>
        ...
        <div className="space-y-6">
          ...
          <div className="border rounded-lg p-6 bg-card shadow-md">
            <h2 className="text-xl font-bold mb-4 text-card-foreground">Guideline Criteria</h2>
            <div className="space-y-2">
              <div className="h-4 w-full bg-muted rounded-md overflow-hidden">
                <div className="h-full w-full animate-ekg origin-left"></div>
              </div>
          ...
          {/* Retrieved Docs */}
          <div className="border rounded-lg p-6 bg-card shadow-md">
            <h2 className="text-xl font-bold mb-4 text-card-foreground">Guideline PDF</h2>
            <div className="space-y-2">
              <div className="h-4 w-full bg-muted rounded-md overflow-hidden">
                <div className="h-full w-full animate-ekg origin-left"></div>
              </div>
